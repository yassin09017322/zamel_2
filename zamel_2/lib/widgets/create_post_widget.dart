...
class _CreatePostWidgetState extends State<CreatePostWidget> {
  ...
  // 8. دالة النشر النهائية المدمجة (هنا تم التعديل الجذري للرفع)
  Future<void> _handlePublish() async {
    ...
    try {
      ...
      // نمرر الرابط الجاهز للشاشة الأب ونمنعها من رفع الملف مرة أخرى بإرسال null
      await widget.onPublish(
        finalText.trim(),
        false,
        _location,
        _mediaType,
        mediaUrl, // الرابط اللي اترفع بنجاح
        null,     // null لملف الجهاز (عشان الشاشة الأب ما ترفع)
        null,     // null لملف الويب (عشان الشاشة الأب ما ترفع)
