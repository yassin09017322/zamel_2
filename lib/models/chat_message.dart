...
class ChatMessage {
  ...
  factory ChatMessage.fromFirestore(DocumentSnapshot<Map<String, dynamic>> doc, String roomId) {
    ...
    final message = ChatMessage()
      ...
      // ✅ Upload tracking fields (not persisted to Firestore, local only)
      ..uploadProgress = 0.0
      ..uploadErrorReason = ''
      ..uploadedBytes = 0
  ...
  factory ChatMessage.fromJson(Map<String, dynamic> json) {
    ...
    // ✅ Upload tracking fields (deserialize if present)
    message.uploadProgress = (json['uploadProgress'] as num?)?.toDouble() ?? 0.0;
    message.uploadErrorReason = json['uploadErrorReason'] as String? ?? '';
    message.uploadedBytes = json['uploadedBytes'] as int? ?? 0;
    message.uploadStartedAt = _parseTimestamp(
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      // ✅ Upload tracking fields (local only, not synced to Firestore)
