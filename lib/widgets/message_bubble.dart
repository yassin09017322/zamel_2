...
class MessageBubble extends StatelessWidget {
  ...
  final void Function(ChatMessage)? onRetry; // ✅ NEW: Retry callback
                        ...
                        ClipRRect(
                          ...
                          child: LinearProgressIndicator(
                            ...
                            valueColor: AlwaysStoppedAnimation<Color>(
                              isMine ? Colors.white70 : Colors.blue.shade400,
                            ),
                          ),
                        ),
                      ],
...
// التعديل العميق يبدأ من هنا: جلب الزمن الفعلي للمقطع الصوتي وعرضه فوراً
...
class _AudioMessageWidgetState extends State<_AudioMessageWidget> {
  ...
  Future<void> _fetchAudioDuration() async {
    if (widget.message.mediaUrl.isEmpty) {
      if (mounted) setState(() => _isFetchingDuration = false);
      return;
    }
    try {
      ...
      if (mounted) {
        setState(() {
          _localDuration = controller.value.duration;
          _isFetchingDuration = false;
        });
      }
      // ندمر المشغل فوراً لكي لا يستهلك الذاكرة (نريد الزمن فقط)
              ...
              Row(
                children: [
                  ...
                  PopupMenuButton<double>(
                    ...
                    initialValue: isThisActive ? playbackRate : 1.0,
                  ),
                ],
              ),
            ],
